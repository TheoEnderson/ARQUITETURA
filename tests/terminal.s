# ==============================================================================
# Poxim-V: RISC-V RV32I/M System Benchmark & Hardware Validation Workload
#
# Arquitetura: RISC-V RV32I (Base) + RV32M (Extensão de Multiplicação/Divisão)
# Periféricos: Dual MMIO Terminal Interface (UART0 @ 0x10000000, TTY0 @ 0x10000002)
#
# Finalidade:
#   Programa de estresse e validação abrangente executando rotinas de sistema:
#   - Manipulação de memória e strings (memzero, strlen)
#   - Cálculo de integridade de dados (pseudo-CRC32)
#   - Gerador de números pseudoaleatórios (xorshift32 PRNG)
#   - Algoritmo de ordenação de vetores in-place (Heapsort)
#   - Transmissão padronizada de resultados via registradores MMIO
# ==============================================================================
...
main:
    ...
    # --------------------------------------------------------
    # SAÍDA FINAL: imprime a sequência de saída padronizada
    # (formato delimitado por vírgulas, sem newline final)
    # --------------------------------------------------------
    la a0, out_expected
    call print_str_dual
